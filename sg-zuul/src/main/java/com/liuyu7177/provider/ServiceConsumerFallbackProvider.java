package com.liuyu7177.provider;
    ...
    public ClientHttpResponse fallbackResponse(String route, Throwable cause) {
        return new ClientHttpResponse() {
            ...
            public InputStream getBody() throws IOException {
                JsonResult<String> result=new JsonResult<String>(true,200,"服务开小差了，请稍后重试...");
                return new ByteArrayInputStream(GsonUtils.objectToJson(result).toString().getBytes("UTF-8"));
            }
